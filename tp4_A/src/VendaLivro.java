...
public class VendaLivro extends ConjLivros{

	/**
	 * Metodo construtor do venda livro
	 */
	public VendaLivro(String titulo, float p, Categoria[] categorias){
		super(titulo);
	}

	/**
	 * Metodo que vai ser chamado pela classe Biblioteca para
	 * efetuar a venda de um livro
	 */
	public static void Venda(){
		Categoria[] categorias = Categoria.values();

		System.out.println("Venda de um livro");
		...
		ConjLivros.adSub(titulo, preco, numCat, "vender");
	}
	...
	/*public static void main(String[] args) {
		...
		VendaLivro ad = new VendaLivro(titulo, preco, numCat);
		//Livro l6 = new Livro(titulo, preco, numCat);
		ConjLivros.adSub(titulo, preco, numCat, "vender");
	}*/
}
